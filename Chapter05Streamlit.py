...
def Chapter5StreamlitUI():
    ...
    # Giao diện Streamlit
    st.title("Ứng dụng Xử lý Ảnh Nhiễu", anchor="app-title")
    ...
    with st.container():
        ...
        st.markdown('<div id="settings-container"></div>', unsafe_allow_html=True)
            ...
            with col2:
                ...
                if selected_option == "Khôi phục ảnh":
                    ...
                    try:
                        ...
                        st.error(f"Lỗi khi lọc nhiễu: {str(e)}", key="error_message")
